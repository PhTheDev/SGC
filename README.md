...
Foi utilizado para desenvolvimento principalmente o framework **Django** do **Python** alem de tecnologias como **HTML/CSS** e a liguagem de programação **JavaScript**.
